...
export function CartPage({ cartItems, onNavigate, onUpdateQuantity, onRemove }: CartPageProps) {
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 sticky top-24 shadow-md">
              ...
              <Button 
                ...
                className="w-full bg-red-600 hover:bg-red-700 h-12 text-lg font-medium shadow-md"
              >
