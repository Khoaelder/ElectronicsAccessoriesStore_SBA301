...
import { Mail, Lock, User, Phone, Facebook, Chrome, Apple } from 'lucide-react';
    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center py-12">
      <Card className="max-w-md w-full mx-4 p-8 shadow-lg">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-500 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-red-600 hover:bg-red-700 h-11 shadow-md">
            Đăng ký
          </Button>
        </form>
