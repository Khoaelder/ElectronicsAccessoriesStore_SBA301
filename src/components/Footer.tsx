        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => onNavigate('products')} className="hover:text-red-500">Phụ kiện điện thoại</button></li>
              <li><button onClick={() => onNavigate('products')} className="hover:text-red-500">Phụ kiện laptop</button></li>
              <li><button onClick={() => onNavigate('products')} className="hover:text-red-500">Thiết bị âm thanh</button></li>
              <li><button onClick={() => onNavigate('products')} className="hover:text-red-500">Phụ kiện gaming</button></li>
              <li><button onClick={() => onNavigate('products')} className="hover:text-red-500">Thiết bị lưu trữ</button></li>
            </ul>
          </div>
