...
export function CheckoutPage({ cartItems, user, onNavigate, onClearCart }: CheckoutPageProps) {
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-sm mb-6">
          ...
          <button onClick={() => onNavigate('cart')} className="text-gray-600 hover:text-red-600">
            Giỏ hàng
          </button>
          <span className="text-gray-400">/</span>
