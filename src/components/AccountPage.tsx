...
import { User, ShoppingBag, Heart, MapPin, Gift, LogOut, Package, Clock, CheckCircle, XCircle } from 'lucide-react';
...
const mockOrders = [
  {
    ...
    status: 'delivered',
    items: [
      { name: 'Tai nghe Gaming RGB Pro', quantity: 1, price: 890000 },
      { name: 'Chuột gaming không dây', quantity: 1, price: 690000 }
    ]
  },
  {
    id: 'DH12345677',
    ...
    status: 'shipping',
    items: [
      { name: 'Sạc nhanh 65W GaN', quantity: 1, price: 450000 }
    ]
  },
  {
    id: 'DH12345676',
    ...
    status: 'processing',
    items: [
      { name: 'Loa bluetooth cao cấp', quantity: 1, price: 1290000 }
    ]
  }
];
...
const vouchers = [
  {
    id: 1,
    code: 'NEWYEAR2026',
    title: 'Giảm 100K cho đơn hàng từ 500K',
    expiry: '31/01/2026',
    used: false
  },
  {
...
export function AccountPage({ user, onNavigate, onLogout }: AccountPageProps) {
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          {/* Sidebar */}
          <Card className="lg:col-span-1 p-6 h-fit shadow-md">
